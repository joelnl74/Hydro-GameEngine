...
/*
 * Memory allocation routines -- route everything through the FBX allocators, 
 * since we ship the xml as part of the fbx toolkit. 
 */
...
#include <fbxsdk/fbxsdk_nsbegin.h>
	...
	#else // (DEBUG_MEMORY_LOCATION) || defined(DEBUG_MEMORY)
		xmlFreeFunc xmlFree = (xmlFreeFunc) FbxFree;
		xmlMallocFunc xmlMalloc = (xmlMallocFunc) FbxMalloc;
		xmlMallocFunc xmlMallocAtomic = (xmlMallocFunc) FbxMalloc;
		xmlReallocFunc xmlRealloc = (xmlReallocFunc) FbxRealloc;
		xmlStrdupFunc xmlMemStrdup = (xmlStrdupFunc) FbxStrDup;
