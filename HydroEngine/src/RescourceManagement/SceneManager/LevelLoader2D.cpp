...
//	if (!ifs)
//	{
//		ERROR("ERROR OPENING FILE FROM DRIVE!, FILE NOT FOUND");
//		return false;
//	}
...
//		
//		if (l_manager->getManager()->count(layer) != NULL)
//		{
...
//bool LevelLoader2D::saveScene(const std::string& inputFileName, LayerManager* l_manager)
//{
